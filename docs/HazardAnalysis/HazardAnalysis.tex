...
\begin{document}
	...
	For Olympian's purposes (and throughout this document), a hazard will be defined as any condition or state which can lead to a state that is likely to negatively affect Olympian's stakeholders.
