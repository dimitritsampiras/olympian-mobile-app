...
\textbf{\href{https://jestjs.io/}{Jest}} will be used for this app's unit testing. Jest is a popular Javascript testing framework that will be used to verify code correctness. Other features offered by Jest that will prove useful include mocking and code coverage insights.
