...
\begin{document}
	...
	This application will be used by fitness enthusiasts and athletes alike to track workouts/programs whilst also being able to initeract with worokouts/programs created and posted by other users. 

	\subsection{Undesired Event Handling}
	When an undesired event occurs, the application will ensure it halts and does not progress further. This will prevent users from entering false inputs into the system with the impression that they are acceptable. The appplication will then notify the user of the undesired event and either suggest an option to progress or to return to a previous state of the application. The halting of the application will allow for user data safety to be maintained.
