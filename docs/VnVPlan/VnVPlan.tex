...
\begin{document}
	...
	\subsubsection{Operational and Environment Tests}
		...
		Initial State: The application is closed and a mobile device is turned on.
		
		Input/Condition: The device downloads and launches the application. All hardware required features are attempted on IOS and Android devices.
		
		Output/Result: There should be complete compatibility for both supported systems without and operation system errors. 
		
		How test will be performed: This test will be done by downloading and running all features on both an IOS and Android device ensuring there are no operation system errors.
