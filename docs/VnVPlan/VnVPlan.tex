...
\begin{table}[h!]
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\\ Rationale: Integration testing is a quintessential process in any software application. Integration testing tests the interaction between components in a system as they are actually deployed.
