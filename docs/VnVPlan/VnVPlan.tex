...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\\ Rationale: Dynamic testing will be a very important part of successfully completing the verification and validation plan for many reasons. Dynamic testing involves executing the system which is required for many parts of integration tests which will be needed for testing the linking between the various parts of the system such as the database interactions and front-back end communication.
		...
		\begin{itemize}
			\item Skill: \textbf{Dynamic Testing}
			\\ Approach 1: Research and contrast various dynamic testing methods such as whitebox and blackbox methods.
			\\ Approach 2: Refer to previous notes on Software Testing 3S03 at McMaster University regarding dynamic testing methodology.
			\\ Verdict: William will use approach 1 to research what methods are the best catered to this project because often tutorials for testing methods go in depth on strategy for approaching dynamic testing. With approach 2, there is only a surface knowledge level of dynamic testing learned from the course. However approach 2 can be used as a good starting point.
		\end{itemize}
	\end{enumerate}
